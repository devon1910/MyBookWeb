...
namespace MybookWeb
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<MybookWebDataContext>(options => options.UseSqlServer(connection));
            ...
            services.AddIdentity<ApplicationUser, ApplicationRole>()
                ...
                .AddEntityFrameworkStores<MybookWebDataContext>();
